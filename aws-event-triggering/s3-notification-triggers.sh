...
email_address="YOUR_PREFERRED_EMAIL"
...
bucket_output=$(aws s3api create-bucket --bucket "$bucket_name"--create-bucket-configuration LocationConstraint="$aws_region" --region "$aws_region")
...
LambdaFunctionArn="arn:aws:lambda:YOUR_PREFERRED_REGION:$aws_account_id:function:s3-lambda-function"
